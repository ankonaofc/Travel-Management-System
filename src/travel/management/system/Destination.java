...
public class Destination extends JFrame implements Runnable{
    ...
    public void run()
    {
        String[] text=new String[]{"JW Marriott Hotel","Radisson Hotel","Four Seasons Hotel","Mandarin Oriental Hotel","ITC Hotel","Novotel","Vivanta Hotel","Paradise Hotel","Taj Hotel","The Oberoi Grand Hotel"};
        try
        {
            for(int i=0;i<8;i++)
            {
    ...
    Destination()
    {
        ...
        ImageIcon[] kimage=new ImageIcon[]{k1,k2,k3,k4,k5,k6,k7,i8,k9,k10};
